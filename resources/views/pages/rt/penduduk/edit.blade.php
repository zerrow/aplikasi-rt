...
@section('content')
    <div class="breadcrumb-wrapper">
        <h1 class="mb-2">Edit Penduduk</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb p-0">
                ...
                <li class="breadcrumb-item" aria-current="page">Edit Penduduk</li>
            </ol>
        </nav>
    </div>
    @if($errors->any())
    ...
    @endif
    <form id="form" method="POST" action="{{route('rt.penduduk.update', $warga->id)}}">
        @csrf
        @method('PUT')
        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-row col-lg-12 col-md-12 col-sm-12 mb-4">
                                ...
                                <input type="text" class="form-control" name="nama"
                                       placeholder="Masukan Nama Lengkap" required value="{{old('nama', $warga->nama)}}">
                            </div>
                            <div class="w-100"></div>
                            <div class="form-row col-lg-6 col-md-6 col-sm-12 mb-4">
                                ...
                                <input type="text" class="form-control" name="nik" id="inputNIK"
                                       placeholder="Masukan NIK" required value="{{old('nik', $warga->nik)}}">
                            ...
                            <div class="form-row col-lg-6 col-md-6 col-sm-12 mb-4">
                                ...
                                <input type="text" class="form-control" name="no_kk" id="inputNoKK"
                                       placeholder="Masukan Nomor KK" required value="{{old('no_kk', $warga->no_kk)}}">
                                <div class="valid-feedback">
                            ...
                            <div class="form-row col-lg-4 col-md-4 col-sm-12 mb-4">
                                ...
                                <input type="date" class="form-control" name="tgl_lahir" id="inputTglLahir"
                                       placeholder="Masukan Tanggal Lahir" required value="{{old('tgl_lahir',$warga->tgl_lahir)}}">
                            </div>
                            <div class="form-row col-lg-4 col-md-4 col-sm-12 mb-4">
                                <label>No. Hp</label>
                                <input type="text" class="form-control" name="no_hp" id="inputHP"
                                       placeholder="Masukan Nomor HP" required value="{{old('no_hp',$warga->no_hp)}}">
                            </div>
                            <div class="w-100"></div>
                            <div class="form-row col-lg-6 col-md-6 col-sm-12 mb-4">
                                ...
                                <ul class="list-unstyled list-inline">
                                    <li class="d-inline-block mr-3">
                                        <label class="control control-radio">Laki Laki
                                            <input type="radio" name="jkel" {{$warga->jkel=='L' ? 'checked' : ''}} value="L"/>
                                            <div class="control-indicator"></div>
                                        </label>
                                    </li>
                                    <li class="d-inline-block mr-3">
                                        <label class="control control-radio">Perempuan
                                            <input type="radio" name="jkel" {{$warga->jkel=='P' ? 'checked' : ''}} value="P"/>
                                            <div class="control-indicator"></div>
                                        </label>
                                    </li>
                                </ul>
                                ...
                                <ul class="list-unstyled list-inline">
                                    <li class="d-inline-block mr-3">
                                        <label class="control control-radio">Belum
                                            <input type="radio" name="status_kawin" {{$warga->status_kawin=='Belum' ? 'checked' : ''}} value="Belum"/>
                                            <div class="control-indicator"></div>
                                        </label>
                                    </li>
                                    <li class="d-inline-block mr-3">
                                        <label class="control control-radio">Sudah
                                            <input type="radio" name="status_kawin" {{$warga->status_kawin=='Sudah' ? 'checked' : ''}} value="Sudah"/>
                                            <div class="control-indicator"></div>
                                        </label>
                                    </li>
                                </ul>
                                ...
                                <ul class="list-unstyled list-inline">
                                    <li class="d-inline-block mr-3">
                                        <label class="control control-radio">WNI
                                            <input type="radio" name="kewarganegaraan" {{$warga->kewarganegaraan=='WNI' ? 'checked' : ''}} value="WNI"/>
                                            <div class="control-indicator"></div>
                                        </label>
                                    </li>
                                    <li class="d-inline-block mr-3">
                                        <label class="control control-radio">WNA
                                            <input type="radio" name="kewarganegaraan" {{$warga->kewarganegaraan=='WNI' ? 'checked' : ''}} value="WNA"/>
                                            <div class="control-indicator"></div>
                                        </label>
                                    </li>
                                </ul>
                                ...
                                <ul class="list-unstyled list-inline">
                                    <li class="d-inline-block mr-3">
                                        <label class="control control-radio">Kepala Keluarga
                                            <input type="radio" name="kedudukan_keluarga" {{ $warga->kedudukan_keluarga=='Kepala' ? 'checked' : ''}}
                                                   value="Kepala"/>
                                            <div class="control-indicator"></div>
                                        </label>
                                    </li>
                                    <li class="d-inline-block mr-3">
                                        <label class="control control-radio">Anggota Keluarga
                                            <input type="radio" name="kedudukan_keluarga" {{ $warga->kedudukan_keluarga=='Anggota' ? 'checked' : ''}} value="Anggota"/>
                                            <div class="control-indicator"></div>
                                        </label>
                                    </li>
                                </ul>
                            ...
                            <div class="form-row col-lg-12 col-md-12 col-sm-12 mb-4">
                                ...
                                <textarea class="form-control mb-2" rows="2" placeholder="Masukan Alamat"
                                          name="alamat_ktp" value="">{{ warga->'alamat_ktp' }}</textarea>
