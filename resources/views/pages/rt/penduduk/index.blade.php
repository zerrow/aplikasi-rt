                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm text-white btn-warning" href="/rt/penduduk/{{$val['id']}}/edit">Edit</a>
                                    <a class="btn btn-sm text-white btn-danger" href="/rt/penduduk/{{$val['id']}}/delete">Delete</a>
                                </td>
                            </tr>
                            @php $no++; @endphp
                            @endforeach
